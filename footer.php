...
<footer id="footer">
    <div class="container">
        <div class="row top-footer">
            <div class="col-sm-4 footer-logo visible-xs">
                <a href="index.php">
                    <img class="center-img" src="images/logo/logo.png" alt="Coral Sand Hotel">
                </a>
            </div>
            <div class="col-sm-4">
                <h3 class="title m_title">NAVIGATION</h3>
                <div class="sbs">
                    <ul class="menu">
                        <li><a href="index.php">HOME</a></li>
                        <li><a href="accommodation.php">ACCOMMODATION</a></li>
                        <li><a href="things_to_do.php">EXCURSIONS</a></li>
            ...
            <div class="col-sm-4">
                <div>
                    <div class="contact-details">
                        ...
                        <ul>
                            <li><i class="fa fa-phone"></i>&nbsp;&nbsp; :<strong class="icon"> +94 (0)91 2277513 </strong></li>
                            <li><i class="fa fa-envelope"></i>&nbsp; : <strong class="icon">coralsands@stmail.lk</strong></li>
                            <li><i class="fa fa-location-arrow"></i> &nbsp;&nbsp;:<strong class="icon"> Coral Sand Hotel<br>

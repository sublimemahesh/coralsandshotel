...
if (isset($_POST['arrange'])) {
    ...
    foreach ($_POST['sort'] as $key => $id) {
        $key = $key + 1;
        $sql = "UPDATE `activity-photo` SET `sort` = '" . $key . "'  WHERE id = '" . $id . "'";
        $db = new DB();
        $db->readQuery($sql);
    }
}
...
$actimages = $actPhoto->getAllByActivityId($activityId);
?>
<!DOCTYPE html>
<html>
    <head>
                                                                        ...
                                                                        <ul id="sortable">
                                                                            ...
                                                                            foreach ($actimages as $key => $actimage) {
                                                                                ...
                                                                                <li class="ui-state-default">
                                                                                    ...
                                                                                    <img width="300px" height="130" class="example-image img-responsive" src="../images/Things_to_do/photos/<?php echo $actimage["image_name"]; ?>" alt=""/>

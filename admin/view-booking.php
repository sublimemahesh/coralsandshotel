            ...
            <div class="content-wrapper">
                ...
                <div class="container">
                    <div class="final-listing datatable1">
                                ...
                                <table id="final-table" class="table table-striped">
                                    ...
                                    foreach ($rooms as $room) {
                                        ...
                                        <tr>
                                            ...
                                            <th><?php if($room['no_of_extra_beds']) { echo $room['no_of_extra_beds']; } else { echo '0'; } ?></th>
                                            <th><?php echo $room['no_of_adults']; ?></th>
                                            <th><?php echo $room['no_of_children']; ?></th>
                                            <th><?php if($room['children_ages']) {echo $room['children_ages'];} else { echo '0'; } ?></th>
                                        </tr>
                                        <?php
                                    }
                                    ?>
                        ...
                        <div class="row">
                            <div class="col-md-3 col-md-offset-9 btns">
                                <a href='manage-bookings.php'><button class="btn btn-primary">Back</button></a>
                                <a class="cancel-booking" id="<?php echo $BOOKING->id; ?>" checkin="<?php echo $BOOKING->checkin; ?>" checkout="<?php echo $BOOKING->checkout; ?>" title="Cancel Booking"><button class="btn btn-danger">Cancel Booking</button></a>
                            </div>

                            ...
                            <tbody>
                                ...
                                foreach ($BOOKING->getUnpaidBooking() as $key => $booking) {
                                    ...
                                    <tr id="booking-id-<?php echo $booking['id']; ?>">
                                        ...
                                        <td style="width:15%"> 
                                            <a class="btn btn-sm btn-info" href="view-unpaid-booking.php?id=<?php echo $booking['id']; ?>" id="<?php echo $booking['id']; ?>" title="View Booking"><i class="glyphicon glyphicon-eye-open"></i></a> | 
                                            <a class="delete-booking btn btn-sm btn-danger" id="<?php echo $booking['id']; ?>" checkin="<?php echo $booking['check_in']; ?>" checkout="<?php echo $booking['check_out']; ?>" title="Delete Booking"><i class="glyphicon glyphicon-trash"></i></a> |
                                            <a class="send-email btn btn-sm btn-primary" id="<?php echo $booking['id']; ?>" total="<?php echo $booking['total_price']; ?>" title="Send Email"><i class="glyphicon glyphicon-send"></i></a>
                                        </td>
                                    </tr>
                                    <?php
                                }

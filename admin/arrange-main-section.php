...
if (isset($_POST['send'])) {
    ...
    foreach ($_POST['sort'] as $key => $id) {
        $key = $key + 1;
        $sql = "UPDATE `main-section` SET `sort` = '" . $key . "'  WHERE id = '" . $id . "'";
        $db = new DB();
        $db->readQuery($sql);
    }
}
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="manage-main-section.php">Manage Main Section</a></li>
                        <li class="active">Arrange Main Section</li>
                    </ol>
                </section>
                                                                    ...
                                                                    <ul id="sortable">
                                                                        ...
                                                                        foreach ($images as $key => $image) {
                                                                            ...
                                                                            <li class = "ui-state-default">
                                                                                ...
                                                                                <img width = "300" height = "200" class = "example-image img-responsive" src = "../images/subsection/<?php echo $image['image_name']; ?>" alt = ""/>

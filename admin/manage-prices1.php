                                                        ...
                                                        <tbody>
                                                            <?php foreach ($details as $detail) {
                                                                ...
                                                                <tr id="price-row-<?php echo $detail['id']; ?>">
                                                                    ...
                                                                    <td><input id="start" class="update-price form-control" type="text" priceid="<?php echo $detail['id']; ?>" value="<?php echo $detail['start']; ?>"/></td>
                                                                    <td><input id="end" class="update-price form-control" type="text" priceid="<?php echo $detail['id']; ?>" value="<?php echo $detail['end']; ?>"/></td>
                                                                    <td><input id="price" class="update-price form-control" type="text" priceid="<?php echo $detail['id']; ?>" value="<?php echo $detail['price']; ?>"/></td>
                                                                    <td><span class="btn btn-danger pull-right delete-price" priceid="<?php echo $detail['id']; ?>"><i class="fa fa-trash" aria-hidden="true"></i></span></td>
                                                                </tr>

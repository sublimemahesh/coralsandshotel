...
if (isset($_POST['send'])) {
    ...
    foreach ($_POST['sort'] as $key => $id) {
        $key = $key + 1;
        $sql = "UPDATE `room-type` SET `sort` = '" . $key . "'  WHERE id = '" . $id . "'";
        $db = new DB();
...
if ($type === 'main') {
    ...
    $roomTypes = RoomType::getAllSubRoomTypes();
}
?>
<!DOCTYPE html>
<html>
                                        ...
                                        <div class="col-md-12">
                                            <div class="panel panel-default">
                                                <div class="panel-heading">
                                                    <?php
                                                    if ($type === 'main') {
                                                        echo 'Arrange Main Room Types';
                                                    } else {
                                                        echo 'Arrange Sub Room Types';
                                                    }
                                                    ?>
                                                </div>
                                                                        ...
                                                                        <ul id="sortable">
                                                                            ...
                                                                            foreach ($roomTypes as $key => $roomType) {
                                                                                ...
                                                                                <li class="ui-state-default">
                                                                                    ...
                                                                                    <img width="300px" height="130" class="example-image img-responsive" src="../images/room-type/<?php echo $roomType["main_photo"]; ?>" title="<?php echo $roomType["room_type"]; ?>" alt=""/>
                                                                                    <input type="hidden" name="sort[]"  value="<?php echo $roomType["id"]; ?>" class="sort-input"/>

...
if (isset($_POST['add'])) {
    ...
    $add = $mainsec->add($_POST, $_FILES);
}

$mainsec = new MainSection();

$mainsections = $mainsec->getAll();
?>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                                ...
                                <div class="tab-pane active" id="eng">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="title" id="title" class="form-control" placeholder="Title" required="TRUE"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="link" class="col-sm-2 control-label">Link</label>
                                            <div class="col-sm-8">
                                                <input type="text" name="link" id="link" class="form-control" placeholder="Link" required="TRUE"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="tab-pane" id="ger">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="title_g" id="title_g" class="form-control" placeholder="Title"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="tab-pane" id="rus">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="title_r" id="title_r" class="form-control" placeholder="Title" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="tab-pane" id="chi">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="title_c" id="title_c" class="form-control" placeholder="Title" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            if ($mainsections) {
                                                ...
                                                <div class="row" id="main-section"> 
                                                    <?php foreach ($mainsections as $mainsection) {
                                                        ?>
                                                        <div class="col-md-4 col-sm-6 col-xs-12" style="padding-bottom: 20px;" id="mainsec_<?php echo $mainsection['id']; ?>">
                                                            <div class="slider-image">
                                                                <a class="info" class="example-image-link" data-lightbox="example-set"  href="../images/main-section//<?php echo $mainsection['image_name']; ?>"> 
                                                                    <img class="example-image img-responsive" src="../images/subsection/<?php echo $mainsection['image_name']; ?>" alt="" width="300" height="200"/> 
                                                                </a> 
                                                            </div>  
                                                            <div class="image-option"> 
                                                                <p class="maxlinetitle"><?php echo $mainsection['title']; ?></p>
                                                                <a href="edit-main-section.php?id=<?php echo $mainsection['id']; ?>" class="btn btn-primary">
                                                                    <span class="glyphicon glyphicon-pencil"></span>
                                                                </a>
                                                                <a href="arrange-main-section.php" class="btn btn-primary">
                                                                    <span class="glyphicon glyphicon-sort"></span>
                                                                </a>
                                                                <a id="<?php echo $mainsection['id']; ?>" class="btn btn-danger delete-main-section">
        ...
        <script src="../js/ajax/main-section.js" type="text/javascript"></script>
    </body>
</html>

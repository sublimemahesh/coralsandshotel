!function (e) {
    ...
    , function () {
        ...
        t.on("arrangeComplete", function () {
            e(".widget-gallery-grid").magnificPopup({
                delegate: ".isotope-item:visible a", type: "image", gallery: {
                    enabled: !0
                }
            }
            )
            ...
            autoplay: true, center: !0, loop: !0, nav: !0, navText: ["", ""], dots: !1, mouseDrag: !1, responsive: {
            0: {
                items: 1
            }
            , 768: {
        ...
        nav: true, autoplay: true, loop: true, dots: false,
        responsive: {
            0: {
                items: 1
            }
        ...
        n.owlCarousel({
            items: 1, nav: !0, navText: ["", ""], dots: !1, mouseDrag: !1
        }
    ...
    if (e(".widget-blog-list").length && e(".widget-blog-list .media-gallery .media-carousel").owlCarousel({
        ...
        , onRefreshed: function () {
            var t = e(".widget-blog-carousel .widget-carousel .blog-item"), i = 0;
    ...
    ), e(".widget-google-map").length)
        try {
            e(".widget-google-map .map-google").width("100%").height("100%").gmap3({
                map: {
                    options: {
                        mapTypeId: google.maps.MapTypeId.ROADMAP, disableDefaultUI: !0, zoomControl: !0, center: [51.5209564, .157134], zoom: 15, scrollwheel: !1, styles: [{
                ...
                , marker: {
                    latLng: [51.5209564, .157134], options: {

...
<html class="no-js" lang="en-US">
    <head>
        ...
        <title>Contact Us | Coral Sands Hikkaduwa</title>
        ...
        <link rel="stylesheet" href="contact-form/style.css" type="text/css"/>
    ...
    <body class="">
        ...
        <div id="page_wrapper">
            <div class="header-section">
                <div class="parallax" style="background-image:url(images/banners/contact-us.jpg); background-repeat:repeat;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="parallax-text">
                                    <h1 class="tbk__title montserrat fs-57 lh-32 fw-extrabold tcolor">Contact Us</h1>
                                    <span><i class="icon-hotel"></i></span>
                                    <ul class="breadcrumb">
                                        <li class="tbk__title montserrat fs-14 lh-22 .fw-vthin tcolor"><a href="./">Home</a></li>
                                        <li class="tbk__title montserrat fs-14 lh-22 .fw-thin tcolor">Contact Us</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-lg-3"></div>
                    ...
                    <section class="hg_section sec1">
                        <div class="section cpadding_top">
                            <div class="wrapper-inner wi-pb10">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="widget-contact-info text-center-sm">
                                            <ul>
                                                <li>
                                                    <h5 class="tbk__title montserrat fs-30 lh-32 fw-bold tcolor">Contact Details</h5>
                                                    <ul>
                                                        <li><i class="fa fa-location-arrow"></i>    : Coral Sand Hotel, No.326, Galle Rd, Hikkaduwa, Sri Lanka.</li>
                                                        <li><i class="fa fa-phone"></i> : +94 (0)91 2277513<!--, +94 (0)91 2277436--></li>
                                                        <li><i class="fa fa-fax"></i>   : +94 (0)91 4383225 </li>
                                                        <li><i class="fa fa-envelope"></i>  : coralsands@stmail.lk</li>
                                                    </ul>
                                                </li>
                                    ...
                                    <div class="col-lg-8">
                                        <div class="contact-form widget-contact-info mb-30">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-xs-12 col-sm-6">
                                                    <div class="col-sm-4">
                                                        <div class="div-check" >
                                                            <img src="contact-form/img/checking.gif" id="checking" alt="" />
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-8 text-right">
                                                        <button type="submit" id="btnSubmit" class="btn btn-default contact-btn">SEND YOUR MESSAGE</button>
                                                    </div> 
                                                </div>
                                            </div>
                                ...
                                <div class="section widget-contact-info mb-20">
                                    <div class="wrapper-full">
                                        <div class="map-google">
                                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d247.934747782975!2d80.0995428281269!3d6.13661899562931!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae177fd991676c3%3A0xacc00c686861269d!2sCoral+Sands+Hotel!5e0!3m2!1sen!2slk!4v1502429948437" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
                                        </div>
                                    </div>
                                </div>
                            </div>

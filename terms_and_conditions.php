...
<html class="no-js" lang="en-US">
    <head>
        ...
        <title>Terms & Conditions | Coral Sands Hikkaduwa</title>
    ...
    <body>
        ...
        <div id="page_wrapper">
            <div class="header-section">
                <div class="parallax" style="background-image:url(images/banners/about-us.jpg); background-repeat:repeat;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="parallax-text">
                                    <h1 class="tbk__title montserrat fs-57 lh-32 fw-extrabold tcolor">Terms & Conditions</h1>
                                    <span><i class="icon-hotel"></i></span>
                                    <ul class="breadcrumb">
                                        <li class="tbk__title montserrat fs-14 lh-22 .fw-vthin tcolor"><a href="./">Home</a></li>
                                        <li class="tbk__title montserrat fs-14 lh-22 .fw-thin tcolor">Terms & Conditions</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-lg-3"></div>
                    ...
                    <section class="hg_section sec1">
                        <div class="wrapper-inner wi-p60">
                            <div class="container terms">
                                <ul>
                                    <li>Check in time 13.00 hrs</li>
                                    <li>Check out time 12.00 hrs</li>
                                    <li>No charge for children under the age of 5 years sharing existing bedding</li>
                                    <li>Maximum of 3 pax in a room</li>
                                    <li>Safety lockers provided for the safekeeping of cash & valuables</li>
                                    <li>Breakfast Buffet :  7.30 am – 9.30 am</li>
                                    <li>Lunch Buffet : 12.30 pm– 2.30 pm</li>
                                    <li>Dinner Buffet :  7.30 pm – 9.30 pm</li>
                                    <li>Cancellation Policy
                                        <ul style="margin-left: 20px;">
                                            <li>The advance payment is subject to our cancellation policy.</li>
                                            <li>If canceled 7 days before the arrival date: refunded in full less any bank charges</li>
                                            <li>If canceled 3 days before the arrival date: 50%</li>
                                            <li>No show: 100%.</li>
                                        </ul>
                                    </li>
                                    <li>Airport transfers available on request</li>
                                    <li>No prepared food from sources other than the Hotel's room service is permitted in the guest rooms</li> 
                                    <li>Free parking</li>
                                    <li>Drivers' accommodation offered on complimentary basis</li>
                                    <li>Additional info can be given separately</li> 
                                </ul>

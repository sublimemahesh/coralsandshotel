...
$allfacilities = $facilities->getFacilities();
?>
...
<html class="no-js" lang="en-US">
    <head>
        ...
        <title>Facility | Coral Sands Hikkaduwa</title>
    ...
    <body>
        ...
        <div id="page_wrapper">
            <div class="header-section">
                <div class="parallax" style="background-image:url(images/banners/facility.jpg); background-repeat:repeat;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="parallax-text">
                                    <h1 class="tbk__title montserrat fs-57 lh-32 fw-extrabold tcolor">Facilities</h1>
                                    <span><i class="icon-hotel"></i></span>
                                    <ul class="breadcrumb">
                                        <li class="tbk__title montserrat fs-14 lh-22 .fw-vthin tcolor"><a href="./">Home</a></li>
                                        <li class="tbk__title montserrat fs-14 lh-22 .fw-thin tcolor">Facility</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-lg-3"></div>
                    ...
                    <section class="hg_section sec1">
                        <div class="wi-p60">
                            <div class="row">
                                <?php
                                foreach ($allfacilities as $key => $allfacility) {
                                    ?>
                                    <div class="col-sm-3 facility">
                                        <div class="col-sm-12 facility-list">
                                            <div class="main-facility-img">
                                                <img src="images/facilities/<?php echo $allfacility['image_name']; ?>" class="img-circle" width="73" alt="credit cards">
                                            </div>
                                            <h3 class="m_title montserrat"><?php echo $allfacility['title']; ?></h3>
                                            <?php echo substr($allfacility['description'], 0, 150); ?>
                                        </div>
                                    </div>

        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#8d8e90">
            <tr>
                <td><table width="600" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center">
                                    ...
                                    <tr>
                                        ...
                                        <td width="144">
                                            <a href= "' . $site_link . '" target="_blank"> '
                                                . '<img src="' . $site_link . '/contact-form/img/logojpg" border="0" alt=""/>
                                            </a>
                                        </td>
                                        <td width="393">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td height="30">
                                                        <img src="' . $site_link . '/img/PROMO-GREEN2_01_04.jpg" width="393" height="30" border="0" alt=""/>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                        ...
                        <tr>
                            <td align="center">
                                <img src="' . $site_link . '/img/PROMO-GREEN2_02.jpg" alt="" width="598" height="323" border="0"/>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="96%" align="center" style="border-bottom:1px solid #000000" height="50">
                                            <font style="font-family: Verdana, Geneva, sans-serif; color:#1400FF; font-size:18px; " >
                                                <h4>Website Inquiry - ' . $comany_name . '</h4>
                                            </font>
                                        </td>
                                        <td width="2%">&nbsp;</td>
                                    </tr>
                            ...
                            <td>
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        ...
                                        <td width="90%" valign="middle">
                                            <font style="font-family: Verdana, Geneva, sans-serif; color:#68696a; font-size:14px; " >
                                                 Thank you for visiting ' . $website_name . ' Your inquiry has been sent to Coral Sands Hotel, Hikkaduwa, Sri Lanka.  A representative of the hotel will contact you shortly. The details of your inquiry are shown below.  
                                                <br/><br/>
                                            </font>
                                        </td>
                                        <td width="5%">&nbsp;</td>
                        ...
                        <tr>
                            <td><img src="' . $site_link . '/img/PROMO-GREEN2_07.jpg" width="598" height="7" style="display:block" border="0" alt=""/></td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                        </tr>
...
$company_message = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
        <title>Promotional email template</title>
                                    ...
                                    <tr>
                                        ...
                                        <td width="90%" valign="middle">
                                            <font style="font-family: Verdana, Geneva, sans-serif; color:#68696a; font-size:14px; text-align:justify; " >
                                               You have a new inquiry from your website on ' . $todayis . ' as follows. Please pay your attention as soon as possible.
                                            </font>
                                        </td>
                                        <td width="5%">&nbsp;</td>
                                    </tr>
                                     <tr>
                                        <td width="5%">&nbsp;<br /><br /></td>
                                        <td width="90%" valign="middle" style="text-align:justify;">
                                            <font style="font-family: Verdana, Geneva, sans-serif; color:#68696a; font-size:14px; " >

...
<html class="no-js" lang="en-US">
    <head>
        ...
        <title>About Us | Coral Sands Hikkaduwa</title>
                ...
                <div class="parallax" style="background-image:url(images/banners/about-us.jpg); background-repeat:repeat;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="parallax-text">
                                    <h1 class="tbk__title montserrat fs-57 lh-32 fw-extrabold tcolor">About Us</h1>
                                    <span><i class="icon-hotel"></i></span>
                                    <ul class="breadcrumb">
                                        <li class="tbk__title montserrat fs-14 lh-22 .fw-vthin tcolor"><a href="./">Home</a></li>
                                        <li class="tbk__title montserrat fs-14 lh-22 .fw-thin tcolor">About Us</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-lg-3"></div>
                    ...
                    <section class="hg_section sec1">
                        <div class="wrapper-inner wi-p60">
                            <div class="container main-facility">
                                <div class="aboutus">
                                    <img src="images/about-us/<?php echo $details['image_name']; ?>" class="img-thumbnail pull-left" alt="">
